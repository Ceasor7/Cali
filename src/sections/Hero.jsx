    ...
    <div className="relative min-h-screen ">
      <div className="w-full min-h-screen relative">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center">
          ...
          <br />
          <span className='text-coral-red inline-block'>Leadership</span> Institute
        </h1>
        <p className='text-base font-montserrat text-coral-red'>
        Building a sustainable future for the arts
        </p>
        <p className='font-montserrat text-coral-red text-lg leading-8 mt-6 mb-14 sm:max-w-sm'>
